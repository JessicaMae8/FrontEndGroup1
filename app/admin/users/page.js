...
const LibraryUsersTable = () => {
    ...
    { id: 1, name: 'Jessa Mae', email: 'jessa@gmail.com', role: 'Student', joined: '2024-09-15', status: 'Active' },
    { id: 2, name: 'Glen', email: 'glen@gmail.com', role: 'Student', joined: '2023-12-01', status: 'Active' },
    { id: 3, name: 'Lea Shine', email: 'shine@gmail.com', role: 'Student', joined: '2025-01-10', status: 'Active' },
    { id: 4, name: 'Nathalie Shaine', email: 'shaine@gmail.com', role: 'Librarian', joined: '2022-07-22', status: 'Active' },
    { id: 5, name: 'Gemma', email: 'gemma@gmail.com', role: 'Student', joined: '2025-01-10', status: 'Inactive' },
    { id: 6, name: 'Dhizon', email: 'dhizon@gmail.com', role: 'Student', joined: '2025-01-10', status: 'Active' },
    { id: 7, name: 'Divan', email: 'divan@gmail.com', role: 'Student', joined: '2025-01-10', status: 'Inactive' },
]);
